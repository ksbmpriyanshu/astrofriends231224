...
const OpenKundli = ({ navigation, dispatch, kundliListData, masterKundliListData }) => {
  ...
  function NoData(){
      return(
                <View style={{flex:1,justifyContent:"center",alignItems:"center",paddingVertical:SCREEN_HEIGHT*0.25}}>
                    <Text style={{...Fonts.black11InterMedium,fontSize:responsiveFontSize(2)}}>No Kundli Available</Text>
                </View>
            )
  }
};
